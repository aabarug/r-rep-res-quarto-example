---
title: "Data Article: Trier social stress test and food-choice: Behavioral, self-report & hormonal data (Adele version)"
...
$\text{Amount}_\text{fruit/vegetable} = - \frac{px}{py} \text{Amount}_\text{sweet/salty} + \frac{m}{py}$

There are `r nrow(df)` patients.
